...
def make_suite(backend_name, Target_Class):
    class_name = f"Test_{Target_Class.__name__}_Save_{backend_name.upper()}"

    class TestModelSave(AetherBaseTestCase):
        NUM_FEATURES = 8
        NUM_CLASSES = 3
        ...
        def test_safetensors_tensor_payload_and_contiguity(self):
            ...
            with zipfile.ZipFile(self.save_path, "r") as zipf:
                ...
                loaded_tensors = safetensors.numpy.load(weights_bytes)
        ...
        def test_complex_cnn_architecture_save(self):
            ...
            with zipfile.ZipFile(self.save_path, "r") as zipf:
                ...
                weights = safetensors.numpy.load(
    ...
    TestModelSave.__name__ = class_name
    TestModelSave.__qualname__ = class_name
    return TestModelSave


for backend in backends_to_test:
    class_name = f"Test_{TARGET_CLASS.__name__}_Save_{backend.upper()}"
