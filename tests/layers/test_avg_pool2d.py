...
class TestAvgPool2d(base_case.AetherBaseLayerTestCase):
    FILTER_SIZE = (2, 2)
    STRIDE = (2, 2)
    PADDING = 'valid'        
    def setUp(self):
    ...
    def test_numpy_cupy_parity(self):
        ...
        cpu_layer = AvgPool2d(filter_size=(2, 2), stride=(2, 2), padding='valid')
...
base_case.register_test_suites(globals(), TestAvgPool2d)