...
def make_dtype_suite(backend_name: str):
    class_name = f"Test_DTypePolicy_{backend_name.upper()}"
    ...
    TestDTypePolicy.__name__ = class_name
    TestDTypePolicy.__qualname__ = class_name
    return TestDTypePolicy


# Register generated test classes for unittest discovery
for backend in backends_to_test:
    suite_cls = make_dtype_suite(backend)
